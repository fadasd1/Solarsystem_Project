...
public class PlanetFactory {
	...
	public static Planet createEarthClose() {
		return new Planet(
				"Earth",
				5.972e24,
				6371_0,
	...
	public static Planet createMercuryClose() {
		return new Planet(
				"Mercury",
				3.301e23,
				2439_0,
	...
	public static Planet createVenusClose() {
		return new Planet(
				"Venus",
				4.867e24,
				6051_0,
	...
	public static Planet createMarsClose() {
		return new Planet(
				"Mars",
				6.417e23,
				3389_0,
	...
	public static Planet createJupiterClose() {
		return new Planet(
				"Jupiter",
				1.898e27,
				69911,
				new Vec(7.785e10, 0, 0),
				new Vec(0, 13070, 0),
				Color.ORANGE
		);
	}

	public static Planet createSaturnClose() {
		return new Planet(
				"Saturn",
				5.683e26,
				58232,
				new Vec(1.433e11, 0, 0),
				new Vec(0, 9690, 0),
				Color.GOLD
		);
	}

	public static Planet createUranusClose() {
		return new Planet(
				"Uranus",
				8.681e25,
				25362,
				new Vec(2.872e11, 0, 0),
				new Vec(0, 6810, 0),
				Color.LIGHTBLUE
		);
	}

	public static Planet createNeptuneClose() {
		return new Planet(
				"Neptune",
				1.024e26,
				24622,
				new Vec(4.495e10, 0, 0),
				new Vec(0, 5430, 0),
				Color.DARKBLUE
		);
	}
